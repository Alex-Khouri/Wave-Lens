...
def drawVariances(variances, outputFilename):
	pass
# *****/HELPER FUNCTIONS/*****
...
try:
	...
	for arg in range(1, len(argv)):
		...
		outputFilename = "Audio Loop Test Output {arg:03}.png"
		drawVariances(variances, outputFilename) # UNFINISHED: Draw variances on graph, then export as image file
