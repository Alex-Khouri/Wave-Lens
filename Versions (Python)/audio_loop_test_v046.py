...
def drawGUI():
	...
	buttonOpenFile.setText("Choose File(s)")
	buttonAnalyseAudio = QPushButton()
	buttonAnalyseAudio.setText("Analyse Audio")
	...
	# boxLoopType.currentTextChanged.connect(boxLoopTypeChange(boxLoopType))
	layout.addWidget(buttonOpenFile)
	layout.addWidget(buttonAnalyseAudio)
	layout.addWidget(boxLoopType)
	layout.addWidget(lineLoopParam1)
	layout.addWidget(lineLoopParam2)
