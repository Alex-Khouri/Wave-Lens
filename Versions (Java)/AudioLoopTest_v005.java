...
public class AudioLoopTest extends Application {
    ...
    public void start(Stage stage) {
		...
		ComboBox<String> boxLoopType = new ComboBox<String>();
		...
		boxLoopType.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                if (boxLoopType.getValue() == "Tempo/Beats") {
					...
					textLoopParam1.setVisible(true);
					textLoopParam2.setVisible(true);
					if (textLoopParam1.getText().isEmpty() || textLoopParam2.getText().isEmpty()) {
						buttonAnalyseAudio.setDisable(true);
					} else {
		...
		textLoopParam1.setOnKeyTyped(new EventHandler<KeyEvent>() {
            @Override
            public void handle(KeyEvent event) {
                if ((boxLoopType.getValue() == "Tempo/Beats" || boxLoopType.getValue() == "Time Range") && (textLoopParam1.getText().isEmpty() || textLoopParam2.getText().isEmpty())) {
					buttonAnalyseAudio.setDisable(true);
				} else {
					buttonAnalyseAudio.setDisable(false);
				}
		...
		textLoopParam2.setOnKeyTyped(new EventHandler<KeyEvent>() {
            @Override
            public void handle(KeyEvent event) {
                if ((boxLoopType.getValue() == "Tempo/Beats" || boxLoopType.getValue() == "Time Range") && (textLoopParam1.getText().isEmpty() || textLoopParam2.getText().isEmpty())) {
					buttonAnalyseAudio.setDisable(true);
